...
for number,file in enumerate(files):
    ...
    cv2.imwrite("./edited/rotated_15_image/15-{}-{}".format(number,file),img_rotate)#15°に変えた画像をrotated_15_imagesに保存
...
for number,file in enumerate(files):
    ...
    M=cv2.getRotationMatrix2D(center,angle,scale)
    img_rotate=cv2.warpAffine(img,M,(w,h))
    cv2.imwrite("./edited/rotated_30_image/30-{}-{}".format(number,file),img_rotate)#30°に変えた画像をrotated_30_imagesに保存
...
for number,file in enumerate(files):
    ...
    M=cv2.getRotationMatrix2D(center,angle,scale)
    img_rotate=cv2.warpAffine(img,M,(w,h))
    cv2.imwrite("./edited/rotated_45_image/45-{}-{}".format(number,file),img_rotate)#45°に変えた画像をrotated_45_imagesに保存
...
for number,file in enumerate(files):
    ...
    M=cv2.getRotationMatrix2D(center,angle,scale)
    img_rotate=cv2.warpAffine(img,M,(w,h))
    cv2.imwrite("./edited/rotated_60_image/60-{}-{}".format(number,file),img_rotate)#60°に変えた画像をrotated_60_imagesに保
...
for number,file in enumerate(files):
    ...
    M=cv2.getRotationMatrix2D(center,angle,scale)
    img_rotate=cv2.warpAffine(img,M,(w,h))
    cv2.imwrite("./edited/rotated_75_image/75-{}-{}".format(number,file),img_rotate)#75°に変えた画像をrotated_75_imagesに保存
...
for number,file in enumerate(files):
    ...
    cv2.imwrite("./edited/rotated_90_image/90-{}-{}".format(number,file),img_rotate)#90°に変えた画像をrotated_90_imagesに保存
...
for number,file in enumerate(files):
    ...
    M=cv2.getRotationMatrix2D(center,angle,scale)
    img_rotate=cv2.warpAffine(img,M,(w,h))
    cv2.imwrite("./edited/rotated_105_image/105-{}-{}".format(number,file),img_rotate)#105°に変えた画像をrotated_105_imagesに保存
...
for number,file in enumerate(files):
    ...
    M=cv2.getRotationMatrix2D(center,angle,scale)
    img_rotate=cv2.warpAffine(img,M,(w,h))
    cv2.imwrite("./edited/rotated_120_image/120-{}-{}".format(number,file),img_rotate)#120°に変えた画像をrotated_120_imagesに保存
...
for number,file in enumerate(files):
    ...
    M=cv2.getRotationMatrix2D(center,angle,scale)
    img_rotate=cv2.warpAffine(img,M,(w,h))
    cv2.imwrite("./edited/rotated_135_image/135-{}-{}".format(number,file),img_rotate)#135°に変えた画像をrotated_135_imagesに保存
...
for number,file in enumerate(files):
    ...
    M=cv2.getRotationMatrix2D(center,angle,scale)
    img_rotate=cv2.warpAffine(img,M,(w,h))
    cv2.imwrite("./edited/rotated_150_image/150-{}-{}".format(number,file),img_rotate)#150°に変えた画像をrotated_150_imagesに保存
...
for number,file in enumerate(files):
    ...
    M=cv2.getRotationMatrix2D(center,angle,scale)
    img_rotate=cv2.warpAffine(img,M,(w,h))
    cv2.imwrite("./edited/rotated_165_image/165-{}-{}".format(number,file),img_rotate)#165°に変えた画像をrotated_165_imagesに保存
...
for number,file in enumerate(files):
    ...
    cv2.imwrite("./edited/rotated_180_image/180-{}-{}".format(number,file),img_rotate)#180°に変えた画像をrotated_180_imagesに保存
...
for number,file in enumerate(files):
    ...
    M=cv2.getRotationMatrix2D(center,angle,scale)
    img_rotate=cv2.warpAffine(img,M,(w,h))
    cv2.imwrite("./edited/rotated_195_image/195-{}-{}".format(number,file),img_rotate)#195°に変えた画像をrotated_195_imagesに保存
...
for number,file in enumerate(files):
    ...
    M=cv2.getRotationMatrix2D(center,angle,scale)
    img_rotate=cv2.warpAffine(img,M,(w,h))
    cv2.imwrite("./edited/rotated_210_image/210-{}-{}".format(number,file),img_rotate)#210°に変えた画像をrotated_210_imagesに保存
...
for number,file in enumerate(files):
    ...
    M=cv2.getRotationMatrix2D(center,angle,scale)
    img_rotate=cv2.warpAffine(img,M,(w,h))
    cv2.imwrite("./edited/rotated_225_image/225-{}-{}".format(number,file),img_rotate)#225°に変えた画像をrotated_225_imagesに保存
...
for number,file in enumerate(files):
    ...
    M=cv2.getRotationMatrix2D(center,angle,scale)
    img_rotate=cv2.warpAffine(img,M,(w,h))
    cv2.imwrite("./edited/rotated_240_image/240-{}-{}".format(number,file),img_rotate)#240°に変えた画像をrotated_240_imagesに保存
...
for number,file in enumerate(files):
    ...
    M=cv2.getRotationMatrix2D(center,angle,scale)
    img_rotate=cv2.warpAffine(img,M,(w,h))
    cv2.imwrite("./edited/rotated_255_image/255-{}-{}".format(number,file),img_rotate)#255°に変えた画像をrotated_255_imagesに保存
    cv2.imwrite("./all_edited_file/r255-{}-{}".format(number,file),img_rotate)
...
for number,file in enumerate(files):
    ...
    cv2.imwrite("./edited/rotated_270_image/270-{}-{}".format(number,file),img_rotate)#270°に変えた画像をrotated_270_imagesに保存
...
for number,file in enumerate(files):
    ...
    M=cv2.getRotationMatrix2D(center,angle,scale)
    img_rotate=cv2.warpAffine(img,M,(w,h))
    cv2.imwrite("./edited/rotated_285_image/285-{}-{}".format(number,file),img_rotate)#285°に変えた画像をrotated_285_imagesに保存
...
for number,file in enumerate(files):
    ...
    M=cv2.getRotationMatrix2D(center,angle,scale)
    img_rotate=cv2.warpAffine(img,M,(w,h))
    cv2.imwrite("./edited/rotated_300_image/300-{}-{}".format(number,file),img_rotate)#300°に変えた画像をrotated_300_imagesに保存
...
for number,file in enumerate(files):
    ...
    M=cv2.getRotationMatrix2D(center,angle,scale)
    img_rotate=cv2.warpAffine(img,M,(w,h))
    cv2.imwrite("./edited/rotated_315_image/315-{}-{}".format(number,file),img_rotate)#315°に変えた画像をrotated_315_imagesに保存
