...
class RotaxSlide:
    ...
    if not os.path.exists("./edited_rotaxslide/rotaxslide_45_image"):
    ...
    if not os.path.exists("./edited_rotaxslide/minus_rotaxslide_45_image"):
        for i in range(45,331,45):
    ...
    for number,file in enumerate(slided_files):
        img=cv2.imread("./edited_slide/slided_x_300_y_300_image/{}".format(file))#絶対パスのみ
        (h,w)=img.shape[:2]
        center=(w/2,h/2)
        angle=-45
        scale=1
    ...
    for number,file in enumerate(slided_files):
        img=cv2.imread("./edited_slide/slided_x_300_y_300_image/{}".format(file))
    ...
    for number,file in enumerate(minus_slided_files):
        img=cv2.imread("./edited_slide/slided_x_-300_y_-300_image/{}".format(file))#絶対パスのみ
        (h,w)=img.shape[:2]
        center=(w/2,h/2)
        angle=45
        scale=1
        M=cv2.getRotationMatrix2D(center,angle,scale)
        img_rotate=cv2.warpAffine(img,M,(w,h))
        cv2.imwrite("./edited_rotaxslide/minus_rotaxslide_45_image/-rs45-{}-{}".format(number,file),img_rotate)#45°に変えた画像をrotaxslide_45_imagesに保存
        cv2.imwrite("./all_edited_file/-rs45-{}-{}".format(number,file),img_rotate)
    ...
    for number,file in enumerate(minus_slided_files):
        img=cv2.imread("./edited_slide/slided_x_-300_y_-300_image/{}".format(file))#絶対パスのみ
        img_rotate=cv2.rotate(img,cv2.ROTATE_90_CLOCKWISE)
        cv2.imwrite("./edited_rotaxslide/minus_rotaxslide_90_image/-rs90-{}-{}".format(number,file),img_rotate)#90°に変えた画像をrotaxslide_90_imagesに保存
        cv2.imwrite("./all_edited_file/-rs90-{}-{}".format(number,file),img_rotate)
    ...
    for number,file in enumerate(minus_slided_files):
        ...
        M=cv2.getRotationMatrix2D(center,angle,scale)
        img_rotate=cv2.warpAffine(img,M,(w,h))
        cv2.imwrite("./edited_rotaxslide/minus_rotaxslide_135_image/-rs135-{}-{}".format(number,file),img_rotate)#135°に変えた画像をrotaxslide_135_imagesに保存
        cv2.imwrite("./all_edited_file/-rs135-{}-{}".format(number,file),img_rotate)


    #minus_slided_filesフォルダ内の写真を全て180°傾ける処理
    for number,file in enumerate(minus_slided_files):
        img=cv2.imread("./edited_slide/slided_x_-300_y_-300_image/{}".format(file))
        img_rotate=cv2.rotate(img,cv2.ROTATE_180)
        cv2.imwrite("./edited_rotaxslide/minus_rotaxslide_180_image/-rs180-{}-{}".format(number,file),img_rotate)#180°に変えた画像をrotaxslide_180_imagesに保存
        cv2.imwrite("./all_edited_file/-rs180-{}-{}".format(number,file),img_rotate)
    ...
    for number,file in enumerate(minus_slided_files):
        ...
        M=cv2.getRotationMatrix2D(center,angle,scale)
        img_rotate=cv2.warpAffine(img,M,(w,h))
        cv2.imwrite("./edited_rotaxslide/minus_rotaxslide_225_image/-rs225-{}-{}".format(number,file),img_rotate)#225°に変えた画像をrotaxslide_225_imagesに保存
        cv2.imwrite("./all_edited_file/-rs255-{}-{}".format(number,file),img_rotate)
    ...
    for number,file in enumerate(minus_slided_files):
        img=cv2.imread("./edited_slide/slided_x_-300_y_-300_image/{}".format(file))
        img_rotate=cv2.rotate(img,cv2.ROTATE_90_COUNTERCLOCKWISE)
        cv2.imwrite("./edited_rotaxslide/minus_rotaxslide_270_image/-rs270-{}-{}".format(number,file),img_rotate)#270°に変えた画像をrotaxslide_270_imagesに保存
        cv2.imwrite("./all_edited_file/-rs270-{}-{}".format(number,file),img_rotate)
    ...
    for number,file in enumerate(minus_slided_files):
        ...
        M=cv2.getRotationMatrix2D(center,angle,scale)
        img_rotate=cv2.warpAffine(img,M,(w,h))
        cv2.imwrite("./edited_rotaxslide/minus_rotaxslide_315_image/-rs315-{}-{}".format(number,file),img_rotate)#315°に変えた画像をrotaxslide_315_imagesに保存
        cv2.imwrite("./all_edited_file/-rs315-{}-{}".format(number,file),img_rotate)